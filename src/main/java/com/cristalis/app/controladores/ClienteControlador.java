...
public class ClienteControlador {
    ...
    public String AgregarNuevoCliente(@ModelAttribute("cliente") ClienteRegistroDTO cliente) {
        ...
        if (cliente.getNombre() != null && cliente.getApellido() != null && cliente.getDni() != null) {
            ...
            ps.guardarPersona(p);
            if (cliente.getCuit() != null && cliente.getRazonSocial() != null && cliente.getFecha() != null) {
                e = new Empresa(cliente.getCuit(), cliente.getRazonSocial(), cliente.getFecha());
    ...
    public String EditarPersona(@PathVariable Long id, Model modelo) {
        ...
        modelo.addAttribute("persona", ps.obtenerPersonaPorID(id));
    ...
    public String EditarEmpresa(@PathVariable Long id, Model modelo) {
        ...
        modelo.addAttribute("empresa", es.obtenerEmpresaPorID(id));
    ...
    public String ActualizarPersona(@PathVariable Long id, @ModelAttribute("persona") Persona persona) {
        ...
        Persona p = ps.obtenerPersonaPorID(id);
